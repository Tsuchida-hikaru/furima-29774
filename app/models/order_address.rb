class OrderAddress
  ...
  attr_accessor :user, :product, :postal_code, :prefecture, :city, :address_number, :apartment_number, :phone_number
  ...
  validates :prefecture format: { other_than: 1,message: '初期値以外を選択してください' }
